...
download.file(url1, destfile = "whr22_rank.xls")

# 2021 World Happiness Report 
url2 <- "https://happiness-report.s3.amazonaws.com/2021/DataForFigure2.1WHR2021C2.xls"
download.file(url2, destfile = "whr21_rank.xls")

url3 <- "https://happiness-report.s3.amazonaws.com/2021/DataPanelWHR2021C2.xls"
download.file(url3, destfile = "whr21_panel_data.xls")

# 2020 World Happiness Report
url4 <- "https://happiness-report.s3.amazonaws.com/2020/WHR20_DataForFigure2.1.xls"
download.file(url4, destfile="whr20_rank.xls")

url5 <- "https://happiness-report.s3.amazonaws.com/2020/WHR20_DataForTable2.1.xls"
download.file(url5, destfile="whr20_panel_data.xls")

# read in the data
whr22_rank <- read_excel("whr22_rank.xls")
whr21_rank<- read_excel("whr21_rank.xls")
whr21_panel_data <- read_excel("whr21_panel_data.xls")
whr20_rank <- read_excel("whr20_rank.xls")
whr21_panel_data <- read_excel("whr20_panel_data.xls")
...
download.file(url4, destfile="ons_data.xlsx")

# read in the data
ons_data <- read_excel("ons_data.xlsx", skip = 2)